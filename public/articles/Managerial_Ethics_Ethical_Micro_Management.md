...
Incentive structures follow two degrees of freedom: control of the input and control of the output. In other words, do we care about what people do, or why they do it? Do we care about PnL or process? Do we care about following direct orders or achieving an objective? 

My thesis is that incentive structures follow this pattern. 
...
The opposite of the Toyota Production System is if employees, or managers, have complete autonomy to decide how they work in order to hit an objective - however the objective itself is non-neogitable and output is very specifically measured against that objective. This is the story told by Ricard Semler who evangelises his mode of management at SemCo, one of Brazil’s most successful manufacturing companies - although it remain private and didn’t realise the sheer scale of success TPS, it helps cohere the other side of the the managerial dipole. Note: one can consider Google and other flat org structures 

## Legal ethics

### Western Legal Tradition: Micro-Manage the output i.e. the impact on society

In the Western legal tradition, actions are judged in context, what an action means depends upon its circumstance, a difference between manslaughter and murder is intent. 

We rely on some kind of delineation between the motivation that caused or produced a phenomena and its end-result.??

The concept of the guilty mind is an essential device in Western law as its the device 
